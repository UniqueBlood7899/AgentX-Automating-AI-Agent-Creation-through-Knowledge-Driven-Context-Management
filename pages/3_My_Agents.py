...
st.set_page_config(page_title="My Agents", page_icon="📂")

st.title("📁 My Agents")
st.write("This page lists Python agent files in `./agents/`. Click **Run** to execute an agent (in a separate process).")
